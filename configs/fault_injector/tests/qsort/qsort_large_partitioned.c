...
struct my3DVertexStruct array[MAXARRAY] __attribute__((section(".data_primary")));
struct my3DVertexStruct array_shadow[MAXARRAY] __attribute__((section(".data_shadow")));
...
main(int argc, char *argv[]) {
  ...
  if (argc<2) {
    ...
    array_shadow[count].x = x;
    array_shadow[count].y = y;
    array_shadow[count].z = z;
    array_shadow[count].distance = array[count].distance;
